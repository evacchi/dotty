...
class VecRDyn[T: Type](implicit st: Staging) extends VecDyn with VecROp[Expr[Int], Expr[T], Expr[Unit]] {
...
class VecRStaDim[T: Type](r: Ring[T])(implicit st: Staging) extends VecROp[Int, T, Expr[Unit]]  {
...
class VecRStaDyn[T : Type : Liftable](r: Ring[PV[T]])(implicit st: Staging) extends VecROp[PV[Int], PV[T], Expr[Unit]] {
...
class VecRStaOptDynInt(r: Ring[PV[Int]])(implicit st: Staging) extends VecRStaDyn(r) {
